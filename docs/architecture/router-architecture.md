...
This document covers the router's integration patterns, event handling, and VDOM patching challenges. For detailed information about layout hierarchies, the pivot algorithm, and the AppShell pattern, see [router-layouts.md](router-layouts.md).
...
For detailed information about the pivot algorithm, layout chains, AppShell pattern, and memory management, see [router-layouts.md](router-layouts.md).
